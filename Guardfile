...
guard :rspec, cmd: "bundle exec rspec",
  ...
  watch(%r{^app/models/fog_bugz\.rb$}) {['spec/models/tracker_spec.rb']}
  watch(%r{^app/models/trac\.rb$})    {[ 'spec/models/tracker_spec.rb']}
  watch(%r{^app/models/tracker\.rb$}) {['spec/models/trac_spec.rb', 'spec/models/fog_bugz_spec.rb']}
